...
public class MiControlBeanInfo extends SimpleBeanInfo
{
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( projectomicontrol.MiControl.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_accessibleHelp] = new PropertyDescriptor ( "accessibleHelp", projectomicontrol.MiControl.class, "getAccessibleHelp", "setAccessibleHelp" ); // NOI18N
            properties[PROPERTY_accessibleRole] = new PropertyDescriptor ( "accessibleRole", projectomicontrol.MiControl.class, "getAccessibleRole", "setAccessibleRole" ); // NOI18N
            properties[PROPERTY_accessibleRoleDescription] = new PropertyDescriptor ( "accessibleRoleDescription", projectomicontrol.MiControl.class, "getAccessibleRoleDescription", "setAccessibleRoleDescription" ); // NOI18N
            properties[PROPERTY_accessibleText] = new PropertyDescriptor ( "accessibleText", projectomicontrol.MiControl.class, "getAccessibleText", "setAccessibleText" ); // NOI18N
            properties[PROPERTY_background] = new PropertyDescriptor ( "background", projectomicontrol.MiControl.class, "getBackground", "setBackground" ); // NOI18N
            properties[PROPERTY_baselineOffset] = new PropertyDescriptor ( "baselineOffset", projectomicontrol.MiControl.class, "getBaselineOffset", null ); // NOI18N
            properties[PROPERTY_blendMode] = new PropertyDescriptor ( "blendMode", projectomicontrol.MiControl.class, "getBlendMode", "setBlendMode" ); // NOI18N
            properties[PROPERTY_border] = new PropertyDescriptor ( "border", projectomicontrol.MiControl.class, "getBorder", "setBorder" ); // NOI18N
            properties[PROPERTY_boundsInLocal] = new PropertyDescriptor ( "boundsInLocal", projectomicontrol.MiControl.class, "getBoundsInLocal", null ); // NOI18N
            properties[PROPERTY_boundsInParent] = new PropertyDescriptor ( "boundsInParent", projectomicontrol.MiControl.class, "getBoundsInParent", null ); // NOI18N
            properties[PROPERTY_cache] = new PropertyDescriptor ( "cache", projectomicontrol.MiControl.class, "isCache", "setCache" ); // NOI18N
            properties[PROPERTY_cacheHint] = new PropertyDescriptor ( "cacheHint", projectomicontrol.MiControl.class, "getCacheHint", "setCacheHint" ); // NOI18N
            properties[PROPERTY_cacheShape] = new PropertyDescriptor ( "cacheShape", projectomicontrol.MiControl.class, "isCacheShape", "setCacheShape" ); // NOI18N
            properties[PROPERTY_centerShape] = new PropertyDescriptor ( "centerShape", projectomicontrol.MiControl.class, "isCenterShape", "setCenterShape" ); // NOI18N
            properties[PROPERTY_childrenUnmodifiable] = new PropertyDescriptor ( "childrenUnmodifiable", projectomicontrol.MiControl.class, "getChildrenUnmodifiable", null ); // NOI18N
            properties[PROPERTY_clip] = new PropertyDescriptor ( "clip", projectomicontrol.MiControl.class, "getClip", "setClip" ); // NOI18N
            properties[PROPERTY_contentBias] = new PropertyDescriptor ( "contentBias", projectomicontrol.MiControl.class, "getContentBias", null ); // NOI18N
            properties[PROPERTY_cssMetaData] = new PropertyDescriptor ( "cssMetaData", projectomicontrol.MiControl.class, "getCssMetaData", null ); // NOI18N
            properties[PROPERTY_cursor] = new PropertyDescriptor ( "cursor", projectomicontrol.MiControl.class, "getCursor", "setCursor" ); // NOI18N
            properties[PROPERTY_depthTest] = new PropertyDescriptor ( "depthTest", projectomicontrol.MiControl.class, "getDepthTest", "setDepthTest" ); // NOI18N
            properties[PROPERTY_disable] = new PropertyDescriptor ( "disable", projectomicontrol.MiControl.class, "isDisable", "setDisable" ); // NOI18N
            properties[PROPERTY_disabled] = new PropertyDescriptor ( "disabled", projectomicontrol.MiControl.class, "isDisabled", null ); // NOI18N
            properties[PROPERTY_effect] = new PropertyDescriptor ( "effect", projectomicontrol.MiControl.class, "getEffect", "setEffect" ); // NOI18N
            properties[PROPERTY_effectiveNodeOrientation] = new PropertyDescriptor ( "effectiveNodeOrientation", projectomicontrol.MiControl.class, "getEffectiveNodeOrientation", null ); // NOI18N
            properties[PROPERTY_eventDispatcher] = new PropertyDescriptor ( "eventDispatcher", projectomicontrol.MiControl.class, "getEventDispatcher", "setEventDispatcher" ); // NOI18N
            properties[PROPERTY_focused] = new PropertyDescriptor ( "focused", projectomicontrol.MiControl.class, "isFocused", null ); // NOI18N
            properties[PROPERTY_focusTraversable] = new PropertyDescriptor ( "focusTraversable", projectomicontrol.MiControl.class, "isFocusTraversable", "setFocusTraversable" ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", projectomicontrol.MiControl.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_hover] = new PropertyDescriptor ( "hover", projectomicontrol.MiControl.class, "isHover", null ); // NOI18N
            properties[PROPERTY_id] = new PropertyDescriptor ( "id", projectomicontrol.MiControl.class, "getId", "setId" ); // NOI18N
            properties[PROPERTY_impl_traversalEngine] = new PropertyDescriptor ( "impl_traversalEngine", projectomicontrol.MiControl.class, "getImpl_traversalEngine", "setImpl_traversalEngine" ); // NOI18N
            properties[PROPERTY_inputMethodRequests] = new PropertyDescriptor ( "inputMethodRequests", projectomicontrol.MiControl.class, "getInputMethodRequests", "setInputMethodRequests" ); // NOI18N
            properties[PROPERTY_insets] = new PropertyDescriptor ( "insets", projectomicontrol.MiControl.class, "getInsets", null ); // NOI18N
            properties[PROPERTY_layoutBounds] = new PropertyDescriptor ( "layoutBounds", projectomicontrol.MiControl.class, "getLayoutBounds", null ); // NOI18N
            properties[PROPERTY_layoutX] = new PropertyDescriptor ( "layoutX", projectomicontrol.MiControl.class, "getLayoutX", "setLayoutX" ); // NOI18N
            properties[PROPERTY_layoutY] = new PropertyDescriptor ( "layoutY", projectomicontrol.MiControl.class, "getLayoutY", "setLayoutY" ); // NOI18N
            properties[PROPERTY_localToParentTransform] = new PropertyDescriptor ( "localToParentTransform", projectomicontrol.MiControl.class, "getLocalToParentTransform", null ); // NOI18N
            properties[PROPERTY_localToSceneTransform] = new PropertyDescriptor ( "localToSceneTransform", projectomicontrol.MiControl.class, "getLocalToSceneTransform", null ); // NOI18N
            properties[PROPERTY_managed] = new PropertyDescriptor ( "managed", projectomicontrol.MiControl.class, "isManaged", "setManaged" ); // NOI18N
            properties[PROPERTY_maxHeight] = new PropertyDescriptor ( "maxHeight", projectomicontrol.MiControl.class, "getMaxHeight", "setMaxHeight" ); // NOI18N
            properties[PROPERTY_maxWidth] = new PropertyDescriptor ( "maxWidth", projectomicontrol.MiControl.class, "getMaxWidth", "setMaxWidth" ); // NOI18N
            properties[PROPERTY_minHeight] = new PropertyDescriptor ( "minHeight", projectomicontrol.MiControl.class, "getMinHeight", "setMinHeight" ); // NOI18N
            properties[PROPERTY_minWidth] = new PropertyDescriptor ( "minWidth", projectomicontrol.MiControl.class, "getMinWidth", "setMinWidth" ); // NOI18N
            properties[PROPERTY_mouseTransparent] = new PropertyDescriptor ( "mouseTransparent", projectomicontrol.MiControl.class, "isMouseTransparent", "setMouseTransparent" ); // NOI18N
            properties[PROPERTY_needsLayout] = new PropertyDescriptor ( "needsLayout", projectomicontrol.MiControl.class, "isNeedsLayout", null ); // NOI18N
            properties[PROPERTY_nodeOrientation] = new PropertyDescriptor ( "nodeOrientation", projectomicontrol.MiControl.class, "getNodeOrientation", "setNodeOrientation" ); // NOI18N
            properties[PROPERTY_onAction] = new PropertyDescriptor ( "onAction", projectomicontrol.MiControl.class, "getOnAction", "setOnAction" ); // NOI18N
            properties[PROPERTY_onContextMenuRequested] = new PropertyDescriptor ( "onContextMenuRequested", projectomicontrol.MiControl.class, "getOnContextMenuRequested", "setOnContextMenuRequested" ); // NOI18N
            properties[PROPERTY_onDragDetected] = new PropertyDescriptor ( "onDragDetected", projectomicontrol.MiControl.class, "getOnDragDetected", "setOnDragDetected" ); // NOI18N
            properties[PROPERTY_onDragDone] = new PropertyDescriptor ( "onDragDone", projectomicontrol.MiControl.class, "getOnDragDone", "setOnDragDone" ); // NOI18N
            properties[PROPERTY_onDragDropped] = new PropertyDescriptor ( "onDragDropped", projectomicontrol.MiControl.class, "getOnDragDropped", "setOnDragDropped" ); // NOI18N
            properties[PROPERTY_onDragEntered] = new PropertyDescriptor ( "onDragEntered", projectomicontrol.MiControl.class, "getOnDragEntered", "setOnDragEntered" ); // NOI18N
            properties[PROPERTY_onDragExited] = new PropertyDescriptor ( "onDragExited", projectomicontrol.MiControl.class, "getOnDragExited", "setOnDragExited" ); // NOI18N
            properties[PROPERTY_onDragOver] = new PropertyDescriptor ( "onDragOver", projectomicontrol.MiControl.class, "getOnDragOver", "setOnDragOver" ); // NOI18N
            properties[PROPERTY_onInputMethodTextChanged] = new PropertyDescriptor ( "onInputMethodTextChanged", projectomicontrol.MiControl.class, "getOnInputMethodTextChanged", "setOnInputMethodTextChanged" ); // NOI18N
            properties[PROPERTY_onKeyPressed] = new PropertyDescriptor ( "onKeyPressed", projectomicontrol.MiControl.class, "getOnKeyPressed", "setOnKeyPressed" ); // NOI18N
            properties[PROPERTY_onKeyReleased] = new PropertyDescriptor ( "onKeyReleased", projectomicontrol.MiControl.class, "getOnKeyReleased", "setOnKeyReleased" ); // NOI18N
            properties[PROPERTY_onKeyTyped] = new PropertyDescriptor ( "onKeyTyped", projectomicontrol.MiControl.class, "getOnKeyTyped", "setOnKeyTyped" ); // NOI18N
            properties[PROPERTY_onMouseClicked] = new PropertyDescriptor ( "onMouseClicked", projectomicontrol.MiControl.class, "getOnMouseClicked", "setOnMouseClicked" ); // NOI18N
            properties[PROPERTY_onMouseDragEntered] = new PropertyDescriptor ( "onMouseDragEntered", projectomicontrol.MiControl.class, "getOnMouseDragEntered", "setOnMouseDragEntered" ); // NOI18N
            properties[PROPERTY_onMouseDragExited] = new PropertyDescriptor ( "onMouseDragExited", projectomicontrol.MiControl.class, "getOnMouseDragExited", "setOnMouseDragExited" ); // NOI18N
            properties[PROPERTY_onMouseDragged] = new PropertyDescriptor ( "onMouseDragged", projectomicontrol.MiControl.class, "getOnMouseDragged", "setOnMouseDragged" ); // NOI18N
            properties[PROPERTY_onMouseDragOver] = new PropertyDescriptor ( "onMouseDragOver", projectomicontrol.MiControl.class, "getOnMouseDragOver", "setOnMouseDragOver" ); // NOI18N
            properties[PROPERTY_onMouseDragReleased] = new PropertyDescriptor ( "onMouseDragReleased", projectomicontrol.MiControl.class, "getOnMouseDragReleased", "setOnMouseDragReleased" ); // NOI18N
            properties[PROPERTY_onMouseEntered] = new PropertyDescriptor ( "onMouseEntered", projectomicontrol.MiControl.class, "getOnMouseEntered", "setOnMouseEntered" ); // NOI18N
            properties[PROPERTY_onMouseExited] = new PropertyDescriptor ( "onMouseExited", projectomicontrol.MiControl.class, "getOnMouseExited", "setOnMouseExited" ); // NOI18N
            properties[PROPERTY_onMouseMoved] = new PropertyDescriptor ( "onMouseMoved", projectomicontrol.MiControl.class, "getOnMouseMoved", "setOnMouseMoved" ); // NOI18N
            properties[PROPERTY_onMousePressed] = new PropertyDescriptor ( "onMousePressed", projectomicontrol.MiControl.class, "getOnMousePressed", "setOnMousePressed" ); // NOI18N
            properties[PROPERTY_onMouseReleased] = new PropertyDescriptor ( "onMouseReleased", projectomicontrol.MiControl.class, "getOnMouseReleased", "setOnMouseReleased" ); // NOI18N
            properties[PROPERTY_onRotate] = new PropertyDescriptor ( "onRotate", projectomicontrol.MiControl.class, "getOnRotate", "setOnRotate" ); // NOI18N
            properties[PROPERTY_onRotationFinished] = new PropertyDescriptor ( "onRotationFinished", projectomicontrol.MiControl.class, "getOnRotationFinished", "setOnRotationFinished" ); // NOI18N
            properties[PROPERTY_onRotationStarted] = new PropertyDescriptor ( "onRotationStarted", projectomicontrol.MiControl.class, "getOnRotationStarted", "setOnRotationStarted" ); // NOI18N
            properties[PROPERTY_onScroll] = new PropertyDescriptor ( "onScroll", projectomicontrol.MiControl.class, "getOnScroll", "setOnScroll" ); // NOI18N
            properties[PROPERTY_onScrollFinished] = new PropertyDescriptor ( "onScrollFinished", projectomicontrol.MiControl.class, "getOnScrollFinished", "setOnScrollFinished" ); // NOI18N
            properties[PROPERTY_onScrollStarted] = new PropertyDescriptor ( "onScrollStarted", projectomicontrol.MiControl.class, "getOnScrollStarted", "setOnScrollStarted" ); // NOI18N
            properties[PROPERTY_onSwipeDown] = new PropertyDescriptor ( "onSwipeDown", projectomicontrol.MiControl.class, "getOnSwipeDown", "setOnSwipeDown" ); // NOI18N
            properties[PROPERTY_onSwipeLeft] = new PropertyDescriptor ( "onSwipeLeft", projectomicontrol.MiControl.class, "getOnSwipeLeft", "setOnSwipeLeft" ); // NOI18N
            properties[PROPERTY_onSwipeRight] = new PropertyDescriptor ( "onSwipeRight", projectomicontrol.MiControl.class, "getOnSwipeRight", "setOnSwipeRight" ); // NOI18N
            properties[PROPERTY_onSwipeUp] = new PropertyDescriptor ( "onSwipeUp", projectomicontrol.MiControl.class, "getOnSwipeUp", "setOnSwipeUp" ); // NOI18N
            properties[PROPERTY_onTouchMoved] = new PropertyDescriptor ( "onTouchMoved", projectomicontrol.MiControl.class, "getOnTouchMoved", "setOnTouchMoved" ); // NOI18N
            properties[PROPERTY_onTouchPressed] = new PropertyDescriptor ( "onTouchPressed", projectomicontrol.MiControl.class, "getOnTouchPressed", "setOnTouchPressed" ); // NOI18N
            properties[PROPERTY_onTouchReleased] = new PropertyDescriptor ( "onTouchReleased", projectomicontrol.MiControl.class, "getOnTouchReleased", "setOnTouchReleased" ); // NOI18N
            properties[PROPERTY_onTouchStationary] = new PropertyDescriptor ( "onTouchStationary", projectomicontrol.MiControl.class, "getOnTouchStationary", "setOnTouchStationary" ); // NOI18N
            properties[PROPERTY_onZoom] = new PropertyDescriptor ( "onZoom", projectomicontrol.MiControl.class, "getOnZoom", "setOnZoom" ); // NOI18N
            properties[PROPERTY_onZoomFinished] = new PropertyDescriptor ( "onZoomFinished", projectomicontrol.MiControl.class, "getOnZoomFinished", "setOnZoomFinished" ); // NOI18N
            properties[PROPERTY_onZoomStarted] = new PropertyDescriptor ( "onZoomStarted", projectomicontrol.MiControl.class, "getOnZoomStarted", "setOnZoomStarted" ); // NOI18N
            properties[PROPERTY_opacity] = new PropertyDescriptor ( "opacity", projectomicontrol.MiControl.class, "getOpacity", "setOpacity" ); // NOI18N
            properties[PROPERTY_opaqueInsets] = new PropertyDescriptor ( "opaqueInsets", projectomicontrol.MiControl.class, "getOpaqueInsets", "setOpaqueInsets" ); // NOI18N
            properties[PROPERTY_padding] = new PropertyDescriptor ( "padding", projectomicontrol.MiControl.class, "getPadding", "setPadding" ); // NOI18N
            properties[PROPERTY_parent] = new PropertyDescriptor ( "parent", projectomicontrol.MiControl.class, "getParent", null ); // NOI18N
            properties[PROPERTY_pickOnBounds] = new PropertyDescriptor ( "pickOnBounds", projectomicontrol.MiControl.class, "isPickOnBounds", "setPickOnBounds" ); // NOI18N
            properties[PROPERTY_prefHeight] = new PropertyDescriptor ( "prefHeight", projectomicontrol.MiControl.class, "getPrefHeight", "setPrefHeight" ); // NOI18N
            properties[PROPERTY_prefWidth] = new PropertyDescriptor ( "prefWidth", projectomicontrol.MiControl.class, "getPrefWidth", "setPrefWidth" ); // NOI18N
            properties[PROPERTY_pressed] = new PropertyDescriptor ( "pressed", projectomicontrol.MiControl.class, "isPressed", null ); // NOI18N
            properties[PROPERTY_properties] = new PropertyDescriptor ( "properties", projectomicontrol.MiControl.class, "getProperties", null ); // NOI18N
            properties[PROPERTY_pseudoClassStates] = new PropertyDescriptor ( "pseudoClassStates", projectomicontrol.MiControl.class, "getPseudoClassStates", null ); // NOI18N
            properties[PROPERTY_resizable] = new PropertyDescriptor ( "resizable", projectomicontrol.MiControl.class, "isResizable", null ); // NOI18N
            properties[PROPERTY_rotate] = new PropertyDescriptor ( "rotate", projectomicontrol.MiControl.class, "getRotate", "setRotate" ); // NOI18N
            properties[PROPERTY_rotationAxis] = new PropertyDescriptor ( "rotationAxis", projectomicontrol.MiControl.class, "getRotationAxis", "setRotationAxis" ); // NOI18N
            properties[PROPERTY_scaleShape] = new PropertyDescriptor ( "scaleShape", projectomicontrol.MiControl.class, "isScaleShape", "setScaleShape" ); // NOI18N
            properties[PROPERTY_scaleX] = new PropertyDescriptor ( "scaleX", projectomicontrol.MiControl.class, "getScaleX", "setScaleX" ); // NOI18N
            properties[PROPERTY_scaleY] = new PropertyDescriptor ( "scaleY", projectomicontrol.MiControl.class, "getScaleY", "setScaleY" ); // NOI18N
            properties[PROPERTY_scaleZ] = new PropertyDescriptor ( "scaleZ", projectomicontrol.MiControl.class, "getScaleZ", "setScaleZ" ); // NOI18N
            properties[PROPERTY_scene] = new PropertyDescriptor ( "scene", projectomicontrol.MiControl.class, "getScene", null ); // NOI18N
            properties[PROPERTY_shape] = new PropertyDescriptor ( "shape", projectomicontrol.MiControl.class, "getShape", "setShape" ); // NOI18N
            properties[PROPERTY_snapToPixel] = new PropertyDescriptor ( "snapToPixel", projectomicontrol.MiControl.class, "isSnapToPixel", "setSnapToPixel" ); // NOI18N
            properties[PROPERTY_style] = new PropertyDescriptor ( "style", projectomicontrol.MiControl.class, "getStyle", "setStyle" ); // NOI18N
            properties[PROPERTY_styleableParent] = new PropertyDescriptor ( "styleableParent", projectomicontrol.MiControl.class, "getStyleableParent", null ); // NOI18N
            properties[PROPERTY_styleClass] = new PropertyDescriptor ( "styleClass", projectomicontrol.MiControl.class, "getStyleClass", null ); // NOI18N
            properties[PROPERTY_stylesheets] = new PropertyDescriptor ( "stylesheets", projectomicontrol.MiControl.class, "getStylesheets", null ); // NOI18N
            properties[PROPERTY_transforms] = new PropertyDescriptor ( "transforms", projectomicontrol.MiControl.class, "getTransforms", null ); // NOI18N
            properties[PROPERTY_translateX] = new PropertyDescriptor ( "translateX", projectomicontrol.MiControl.class, "getTranslateX", "setTranslateX" ); // NOI18N
            properties[PROPERTY_translateY] = new PropertyDescriptor ( "translateY", projectomicontrol.MiControl.class, "getTranslateY", "setTranslateY" ); // NOI18N
            properties[PROPERTY_translateZ] = new PropertyDescriptor ( "translateZ", projectomicontrol.MiControl.class, "getTranslateZ", "setTranslateZ" ); // NOI18N
            properties[PROPERTY_typeSelector] = new PropertyDescriptor ( "typeSelector", projectomicontrol.MiControl.class, "getTypeSelector", null ); // NOI18N
            properties[PROPERTY_userAgentStylesheet] = new PropertyDescriptor ( "userAgentStylesheet", projectomicontrol.MiControl.class, "getUserAgentStylesheet", null ); // NOI18N
            properties[PROPERTY_userData] = new PropertyDescriptor ( "userData", projectomicontrol.MiControl.class, "getUserData", "setUserData" ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", projectomicontrol.MiControl.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", projectomicontrol.MiControl.class, "getWidth", null ); // NOI18N
        }
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_onActionProperty111] = new MethodDescriptor(projectomicontrol.MiControl.class.getMethod("onActionProperty", new Class[] {})); // NOI18N
